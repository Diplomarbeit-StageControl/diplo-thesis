...
ESP32 ist eine Reihe von Chip-Mikrocontrollern, die von dem Unternehmen Espressif entwickelt wurden und mit Hilfe von Arduino kommunizieren. Der ESP32 \textcite{ESP32} zeichnet sich mit folgenden Dingen aus:
